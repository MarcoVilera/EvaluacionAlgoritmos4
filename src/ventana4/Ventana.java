...
public class Ventana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.add(barraHeader, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1000, 31));

        headerPanel.setBackground(new java.awt.Color(0, 121, 107));
        headerPanel.setPreferredSize(new java.awt.Dimension(900, 70));

        labelTitle.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        labelTitle.setForeground(new java.awt.Color(255, 255, 255));
        labelTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelTitle.setText("Evaluación 4 Algoritmos y Estructuras");
        ...
        background.add(headerPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 1000, 70));
